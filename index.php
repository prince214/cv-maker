...
<div class=" bg" style="text-align: center; ">
    ...
    <div id="content" class="content">
        <h1>Create your own Resume here</h1>
            ...
            <a href="http://api.html2pdfrocket.com/pdf?value=http://127.0.0.1/htdocs/cvBuilder/cvBuilder/cv/index.php&apikey=0bb4f0a6-97df-4276-ac93-ce3bbff400c4">Download PDF</a>
    </div>
</div>

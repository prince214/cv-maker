...
<?php
      ...
      // $document->stream("Webslesson", array("Attachment"=>0));
        // curl -H 'Authentication: Token BMwvgLKf5xFXDAMIwJfjucV4OSjWcFNo' \
        // -F 'file=@interests.html' \
                ...
                <form id="interest_form" class="form-horizontal" >
                    <fieldset>
                        ...
                        <div class="form-group">
                           ...
                           <!--  <div class="col-md-12 text-center">
                            <input type="submit" name="downloadPDF" class="btn btn-primary btn-lg" value = "Download">    
...
// document.getElementById("#myBtn").addEventListener("click", function(){
  ...
  // window.location.href = "https://v2018.api2pdf.com/chrome/url?url=http://localhost/htdocs/cvBuilder/cvBuilder/cv/template/index.php&apikey=28930984-0899-47b2-a447-4ea4a050c5da";

  // window.location.href = "https://v2018.api2pdf.com/chrome/url?url=http://localhost/htdocs/cvBuilder/cvBuilder/cv/template/index.php&apikey=28930984-0899-47b2-a447-4ea4a050c5da";

  // window.location.href = "https://v2018.api2pdf.com/wkhtmltopdf/url?url=http://localhost/htdocs/cvBuilder/cvBuilder/cv/template/index.php&apikey=28930984-0899-47b2-a447-4ea4a050c5da";

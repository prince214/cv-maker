...
<body>     <center>
        ...
        <!-- <a href="//pdfcrowd.com/13.126.165.2/cv/template/index.php">Save to PDF</a> -->
        <a class="btn"href="//pdfcrowd.com/url_to_pdf/">Save to PDF</a>
                <form action="index.php" method="post">
                  <input type="submit" value="Submit" name="submit" />
                </form> 
         <input class="btn" type="button" id="download" name="download" value="Download" onclick="download()">
         <a href="http://html2pdfrocket.com/html/topdf?apikey=0bb4f0a6-97df-4276-ac93-ce3bbff400c4">Download Current Page as PDF</a>
         <a href="http://api.html2pdfrocket.com/pdf?value=http://localhost/htdocs/cvBuilder/cvBuilder/cv/template/index.php&apikey=0bb4f0a6-97df-4276-ac93-ce3bbff400c4">Download PDF</a>
    </center> 
  <div class="container">
    <section>
      <div>
   ...
   <script>
    function download(){
      window.location.href = "https://v2018.api2pdf.com/chrome/url?url=http://localhost/htdocs/cvBuilder/cvBuilder/cv/template/index.php&apikey=0830bc09-9480-414b-82e3-e866e16c53c5";
    }
  </script>
</body>
</html>
...
// ob_end_clean();
// // $output = file_get_contents('http://localhost/htdocs/cvBuilder/cvBuilder/cv/template/index.php');
